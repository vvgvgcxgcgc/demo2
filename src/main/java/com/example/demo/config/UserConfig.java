        ...
        http
                ...
                .authorizeHttpRequests( author ->
                            author.requestMatchers(PathRequest.toStaticResources().atCommonLocations()).permitAll()
                                  ...
                                  .requestMatchers("/admin-update-product/","/admin-products","/admin-dashboard","/admin-add-product", "/admin-orders-pending", "/admin-orders-completed","/admin-feedbacks", "/admin-customers", "/admin-add-voucher", "/admin-vouchers").hasAuthority("ADMIN")
